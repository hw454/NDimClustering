...
QCFilter_Iter <- function(unstdBeta_df,unstdSE_df,pval_df,
                                tstat_df,trait_info,fpaths_fil_dir,ai=1){
  ...
  save(list=savelist, file = paste0(res_dir,"QCdata_",EXP_pheno,"ClusterIter",ai,".Rdata"))
}